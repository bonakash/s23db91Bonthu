...
res.render('index', { title: 'Kitchen App', user : req.user });
});
router.get('/register', function(req, res) {
res.render('register', { title: 'Kitchen App Registration'});
});
...
router.get('/login', function(req, res) {
  res.render('login', { title: 'Kitchen App Login', user : req.user });
});
...
//   res.render('index', { title: 'Akash Bonthu' });
// });
